...
# TARGETS: Which hosts do we build for? web linux linuxdrm macos mswin generic, or make one up and define it below.
TARGETS:=web linux linuxdrm generic
...
generic_OPT_ENABLE:=genioc io fs a_dummy v_dummy i_dummy r1b synmin gcfg inmgr
...
linux_OPT_ENABLE:=genioc io fs a_pulse v_xegl i_evdev xinerama r1b synmin gcfg inmgr
...
macos_OPT_ENABLE:=macos io fs r1b synmin gcfg inmgr
...
mswin_OPT_ENABLE:=mswin genioc io fs r1b synmin gcfg inmgr
